...
public class DateUtil {
    ...
    public static String getNextDay(String dateString) {
        ...
        return getStringByPattern(addDays, "yyyy-MM-dd");
    }
     ...
     * @throws Exception
     */
    public static int getAge(Date birthDay, Date evalDate) throws Exception {
        return getDayDiff(birthDay, evalDate) / 365;
    }
